 ...
 * Controller中需要有专门处理异常的方法。<br>
 * 
 * @author chen.feng
 * @date 2014-6-22 下午3:29:50
 */
public class GlobalExceptionResolver extends ExceptionHandlerExceptionResolver {
	...
	protected ModelAndView doResolveHandlerMethodException(
		...
		logger.error("发生异常的类名：{}", handlerMethod);
		...
		//保存异常日志
//		ExceptionServiceHandle.saveExceptionLog(exception, method.getName());
		
		logger.error("发生异常的方法名称：{}", method.getName());
		logger.error("发生的异常信息：{}", exception);
