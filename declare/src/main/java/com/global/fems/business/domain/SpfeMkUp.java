...
public class SpfeMkUp extends Entity{
	...
	private String BIZ_TX_CHNL_CODE;//业务办理渠道
	...
	@ColumnMapping(columnName = "REIN_REASON_CODE", columnType = "String")
	private String REIN_REASON_CODE;//补录原因代码
	@ColumnMapping(columnName = "REIN_REMARK", columnType = "String")
	private String REIN_REMARK;//补录说明
	@ColumnMapping(columnName = "sfzx", columnType = "String")
	private String sfzx = "Y";
