...
function initDataGrid(){
	grid = $('#grid').datagrid({
        methord: 'post',
        url: '${pageContext.request.contextPath}/flow/tasklistController.do?method=queryWaitTaskList',
        sortName: 'createDate',
        sortOrder: 'desc',
        idField: 'txnSerialNo',
        pageSize: 20,
        pageList: [10,20,50],
        columns: [[
					{ field: 'txnSerialNo', title: '业务流水号', width: 100, sortable: false },
					...
					{field:'opt',title:'操作',width:100,align:'center', rowspan:2,
						formatter:function(value,rec){
							return '<span style="color:blue"><a href="###" onclick="doProcess(\''+rec.txnSerialNo+'\',\''+rec.transState+'\',\''+rec.url+'\')">办理</a></span>';
						}
					}
				]],
        fit:true,
...
<div id="center-div" class="easyui-layout" fit="true">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3" >
							...
							&nbsp;&nbsp;<input id="save" type="button" class="inputButton" value="查询" onclick="queryWaitTask();"/> 
						</td>
					</tr>
				</tbody>
			</table>
    ...
    <div region="center" style="width: 500px; height: 300px; padding: 1px;overflow-y: hidden" title="待办任务列表">
        <div id="grid" > </div>
    </div>
  </div>
</div>
