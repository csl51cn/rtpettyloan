...
<head>
    ...
    <script type="text/javascript">
        ...
        urlMap.set("0107", "${basePath}/pettyLoanContract.do?method=findPettyLoanContractBySendStatus");//0107交易类型 网签信息上报
        ...
        <div class="editBlock">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="startDate" autocomplete="off" name="startDate"
                               style="border:1px solid #95B8E7;*color:#007fca;width:170px;padding:4px 2px;"
                               onclick="WdatePicker()"/> 至
                        <input type="text" id="endDate"  autocomplete="off" name="endDate" style="border:1px solid #95B8E7;
