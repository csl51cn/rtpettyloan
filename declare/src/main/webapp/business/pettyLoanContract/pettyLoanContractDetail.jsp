			...
			<table width="99%">
				...
				<tr>
					...
					<td width="25%">
						...
						/>
						<input type="text" id="contractNo" name="contractNo" disabled="disabled" readonly="readonly"
							   value="${model.contractNo}" class="inputText"
						/></td>
					<th width="15%">贷款类型</th>
					<td>

						<input class="easyui-combogrid" id="loanCate" name="loanCate" style="width:251px;" disabled="disabled" readonly="readonly"
				...
				<tr>
					...
					<td width="25%">
						...
						<input class="easyui-combogrid" id="customerType" name="customerType" style="width:251px;" disabled="disabled" readonly="readonly"
					...
					<td>
						<input type="text" id="customerName" name="customerName" disabled="disabled" readonly="readonly"
				...
				<tr>
					...
					<td width="25%">
						<input class="easyui-combogrid" id="certificateType" name="certificateType" style="width:251px;" disabled="disabled" readonly="readonly"
					...
					<td>
						<input type="text" id="certificateNo" name="certificateNo" disabled="disabled" readonly="readonly"
				...
				<tr>
					...
					<td width="25%">
						...
						<input class="easyui-combogrid" id="conCustomerType" name="conCustomerType" style="width:251px;" disabled="disabled" readonly="readonly"
					...
					<td>
						<input type="text" id="conCustomerName" name="conCustomerName" disabled="disabled" readonly="readonly"
				...
				<tr>
					...
					<td width="25%">
						<input class="easyui-combogrid" id="conCertificateType" name="conCertificateType" disabled="disabled" readonly="readonly"
					...
					<td>
						<input type="text" id="conCertificateNo" name="conCertificateNo" disabled="disabled" readonly="readonly"
				...
				<tr>
					...
					<td width="25%">
						<input type="text" id="conFee" name="conFee" disabled="disabled" readonly="readonly"
							   value="${model.conFee}" class="inputText">
					</td>
					<th width="15%">合同金额</th>
					<td>
						<input type="text" id="contractAmount" name="contractAmount" disabled="disabled" readonly="readonly"
				...
				<tr>
					<th width="15%">月利率</th>
					<td width="25%">
						<input type="text" id="intRate" name="intRate" disabled="disabled" readonly="readonly"
							   value="${model.intRate}" class="inputText">
					</td>
					<th width="15%">合同签订日期</th>
					<td>
						<input type="text" id="contractSignDate" name="contractSignDate" disabled="disabled" readonly="readonly"
