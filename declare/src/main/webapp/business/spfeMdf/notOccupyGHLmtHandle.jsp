			...
			<tbody>
				<tr>
					...
					<td><ebills:select id="TX_CODE" name="TX_CODE"
							...
							diccode="GHZJSX_CODE" clazz="easyui-combobox"></ebills:select></td>
				</tr>
				<tr>
				...
				<tr id="GH0503">
					...
					<td><input type="text" id="PURFX_CASH_AMT" maxlength="18"  onblur="querySafeExRate(this)"
				...
				<tr id="GH0504">
					...
					<td><input type="text" id="FCY_REMIT_AMT" name="FCY_REMIT_AMT"  validType="amt"
				...
				<tr id="GH0501" >
					...
					<td width="25%" colspan="3"><input type="text" id="PAY_ORG_CODE" name="PAY_ORG_CODE"
						value="${mode.PAY_ORG_CODE}" class="inputText"  maxlength="9"/></td>
				</tr>
				<tr>
					<th width="15%"><span class="warning">*</span>业务办理时间</th>
					<td colspan="3">
						<input  type="text" class="easyui-datebox" name="BIZ_TX_TIME"  data-options="disabled:true,required:true"  style="width:250px"   id="BIZ_TX_TIME"  value="${mode.BIZ_TX_TIME}" />
					</td>
				</tr>
