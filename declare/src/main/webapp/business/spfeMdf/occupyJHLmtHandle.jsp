		...
		<table width="99%">
			...
			<tbody>
				<tr>
					...
					<td width="34%"><ebills:select id="TX_CODE" name="TX_CODE"
							value="${mode.TX_CODE}"
				...
				<tr>
					...
					<td width="35%"><select name="TXCCY" id="TXCCY"
					...
					<td width="34%"><ebills:select id="SALEFX_SETTLE_CODE"
				...
				<tr>
					...
					<td width="35%"><input type="text"  disabled id="TXAMTUSD" name="TXAMTUSD"
				...
				<tr>
					...
					<td width="34%"><input type="text" id="LCY_ACCTNO_CNY"
