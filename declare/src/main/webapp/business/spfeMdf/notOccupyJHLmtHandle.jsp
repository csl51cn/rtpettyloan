		...
		<table width="99%">
			...
			<tbody>
				<tr>
					...
					<td><ebills:select id="TX_CODE" name="TX_CODE"
							value="${mode.TX_CODE}"
							expAttribute='data-options="required:true,editable:false"' style="width:250px"
							diccode="JHZJSX_CODE" clazz="easyui-combobox"></ebills:select></td>
				</tr>
				<tr>
					<th width="15%"><span class="warning">*</span>币种</th>
					<td ><select name="TXCCY" id="TXCCY"
				...
				<tr id="JH0501" >
					...
					<td width="35%" colspan="3"><input type="text" id="PAY_ORG_CODE" name="PAY_ORG_CODE"
						value="${mode.PAY_ORG_CODE}" class="inputText"
						data-options="required:false" /></td>
				</tr>
				<tr>
					<th width="15%"><span class="warning">*</span>业务办理时间</th>
					<td colspan="3">
						<input  type="text"  name="BIZ_TX_TIME"   data-options="disabled:true,required:true"  style="width:250px"   id="BIZ_TX_TIME"  value="${mode.BIZ_TX_TIME}" />
					</td>
				</tr>
				<tr style="display:none" id="refnotr">
					<th width="15%">业务参号</th>
					<td colspan="3">
						<input  type="text" class="inputText"  id="refNo"  data-options="required:true" disabled style="width:250px"  value="${mode.REFNO }" />
					</td>
				</tr>
				<tr>
					<th width="15%">备注</th>
					<td colspan="3" style="border-top: 1px"><textarea rows="1"
							cols="1" style="height: 50px; width: 98%" id="REMARK"  ischg='N' onmousedown="this.attributes['ischg'].nodeValue='Y'"
