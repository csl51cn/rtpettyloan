...
<title>						<c:if test="${mode.BIZ_TYPE_CODE=='01' }">占用额度的结汇</c:if>
						 	...
						 	<c:if test="${sfbl=='N' }">录入</c:if>通知书</title>
<jsp:include page="../../common/include.jsp"></jsp:include>
<style type="text/css" media="print">.Noprint{DISPLAY:none}</style>
<!-- <style type="text/css">
	.editBlock table{border-right:1px solid ;border-bottom:1px solid}
	.editBlock table td{border-left:1px solid ;border-top:1px solid}
	.editBlock table th{border-left:1px solid ;border-top:1px solid}
</style> -->
...
<OBJECT ID="wb" CLASSID="CLSID:8856F961-340A-11D0-A96B-00C04FD705A2" name="wb" height="0" width="0" ></OBJECT>
	...
	<div region="center" border="false">
		<div class="editBlock">
			<table width="99%" bordercolor="#EOFFFF">				
				<tbody>
					<tr>						
					...
					<tr>						
						<td colspan="4" style="height: 30px;">
							<span class="warning">*</span>&nbsp;&nbsp;本年额度内已结汇金额（折美元&nbsp;包括本次）：<font color="red">${mode.AMT_USD}</font>
						</td>						
					</tr>
					</c:if>
					<tr>
